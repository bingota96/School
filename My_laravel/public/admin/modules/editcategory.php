                  ...
                  <div class="x_content">
                    ...
                    <?php  
                      ...
                      if(isset($_GET["id"])){
                        $id = $_GET["id"];
                        $condition = " cat_id = $id";
                        $row = getById("tbl_category",$condition);
                      }
                    ?>
                    <form method="post" action="" class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="<?php echo $row["cat_name"] ?>" name="cat_name" id="cat_name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="checkbox" <?php echo ($row["status"])?"checked":""; ?> id="status" value="1" name="status" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
